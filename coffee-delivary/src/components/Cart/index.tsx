...
export function Cart() {
  ...
  const totalPrice = useMemo(
    () =>
      coffees.reduce(
        (sumTotal, coffee) => (sumTotal += coffee.price * coffee.amount),
        0,
      ),
    [coffees],
  )
                ...
                <div className={styles.detailsCoffee}>
                  <div className={styles.actionsCart}>
                    ...
                    <div className={styles.addonsCoffeeCart}>
                      <button
                        type="button"
                        onClick={() => decrementCoffeeCart(coffee.id)}
                      ...
                      <button
                        type="button"
                        onClick={() => incrementCoffeeCart(coffee.id)}
        ...
        <div className={styles.footerContent}>
          ...
          <div className={styles.infoItem}>
            ...
            <span className={styles.total}>
              R$ {formatNumber(totalPrice + deliveryValue)}
            </span>
          </div>
        </div>
